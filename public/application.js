...
var getDrawings = function getDrawings(data) {
  return $.ajax({
...
var getUserDrawings = function getUserDrawings(data) {
  return $.ajax({
...
var createDrawing = function createDrawing(data) {
  return $.ajax({
    url: app.host + 'drawings/',
    method: 'POST',
    headers: {
...
var deleteDrawing = function deleteDrawing(data) {
  return $.ajax({
...
var updateDrawing = function updateDrawing(data) {
  return $.ajax({
...
module.exports = {
  ...
  getUserDrawings: getUserDrawings,
...
var userEvents = __webpack_require__(11);
var drawingEvents = __webpack_require__(14);
var drawingsApi = __webpack_require__(4);
...
var onSignUp = function onSignUp(event) {
  ...
  if (data.credentials.email === '' || data.credentials.password === '' || data.credentials.password_confirmation === '') {
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).done(ui.onSignInSuccess).fail(ui.onSignInFailure);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signOut(data).done(ui.onSignOutSuccess).fail(ui.onSignOutFailure);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.changePassword(data).done(ui.onChangePasswordSuccess).fail(ui.onChangePasswordFailure);
};
...
var badPasswordConfirmation = function badPasswordConfirmation() {
  $('#sign-up').find('.error').remove();
  $('#sign-up').append('<p class="error"> Password Confirmation Not Matching</p>');
};

var incompleteSignUpError = function incompleteSignUpError() {
  $('#sign-up').find('.error').remove();
  $('#sign-up').append('<p class="error">Please Fill All Fields</p>');
};
...
var onSignUpFailure = function onSignUpFailure(error) {
  ...
  $('#sign-up').find('.error').remove();
  $('#sign-up').append('<p class="error">Sorry, Email Already In Use</p>');
  $('input:not([type="submit"]), textarea').val('');
};
...
var onSignInFailure = function onSignInFailure(error) {
  ...
  $('#sign-in').find('.error').remove();
  $('#sign-in').append('<p class="error">Username and or Password Incorrect</p>');
  $('input:not([type="submit"]), textarea').val('');
};
...
module.exports = {
  ...
  badPasswordConfirmation: badPasswordConfirmation,
  incompleteSignUpError: incompleteSignUpError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onGetDrawings = function onGetDrawings(event) {
  api.getDrawings().then(ui.onGetDrawingsSuccess).catch(ui.onGetDrawingsFailure);
};

var onGetUserDrawings = function onGetUserDrawings(event) {
  api.getUserDrawings().then(ui.onGetUserDrawingsSuccess).catch(ui.onGetUserDrawingsFailure);
};

var onAddDrawing = function onAddDrawing(event) {
  var imgCheck = /(http(s?):)([/|.|\w|\s|-])*\.(?:jpg|png|jpeg)/;
  var urlCheck = /[-a-zA-Z0-9@:%_.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_.~#?&//=]*)?/;
  event.preventDefault();
  var data = getFormFields(event.target);
  ...
  if (Object.values(data.credentials).indexOf('') > -1) {
    ...
    api.createDrawing(data).then(ui.onAddDrawingSuccess).then(function () {
      return onGetUserDrawings();
    }).catch(ui.onAddDrawingFailure);
  }
};

var onDeleteDrawing = function onDeleteDrawing(event) {
  var data = event;
  api.deleteDrawing(data).then(ui.onDeleteDrawingSuccess).then(function () {
    return onGetUserDrawings();
  }).catch(ui.onDeleteDrawingFailure);
};

var onUpdateDrawing = function onUpdateDrawing(event) {
  ...
  if (Object.values(data.credentials).indexOf('') > -1) {
    ...
    api.updateDrawing(data).then(ui.onUpdateDrawingSuccess).then(function () {
      return onGetUserDrawings();
...
module.exports = {
  onGetDrawings: onGetDrawings,
  onGetUserDrawings: onGetUserDrawings,
...
var loopAllDrawings = function loopAllDrawings(data) {
  for (var i = 0; i < data.drawings.length; i++) {
    $('#home-feed').append('<div class="drawing-container">' + '<h1 class="drawing-header">' + data.drawings[i].songTitle + '</h1>' + '<img class="drawing-image" src="' + data.drawings[i].imageLink + '">' + '<div class="song-info">' + '<div>' + '<h4>- Song Title -</h4>' + '<p class="song-info">' + data.drawings[i].songTitle + '</p>' + '</div>' + '<div>' + '<h4>- Artist -</h4>' + '<p class="song-info">' + data.drawings[i].songArtist + '</p>' + '</div>' + '</div>' + '<h3 class="drawing-header">Lyrics</h3>' + '<p class="drawing-lyrics">' + data.drawings[i].lyrics + '</p>' + '<p class="check-out-song">' + '<a target="about_blank" href="' + data.drawings[i].songLink + '">Check Out the Song</a>' + '</p>' + '</div>');
  }
};

var loopUserDrawings = function loopUserDrawings(data) {
  $('#user-drawings').children().remove();
  for (var i = 0; i < data.drawings.length; i++) {
    $('#user-drawings').append('<div class="drawing-container">' + '<h1 class="drawing-header">' + data.drawings[i].songTitle + '</h1>' + '<img class="drawing-image" src="' + data.drawings[i].imageLink + '">' + '<div class="song-info">' + '<div>' + '<h4>- Song Title -</h4>' + '<p class="song-info">' + data.drawings[i].songTitle + '</p>' + '</div>' + '<div>' + '<h4>- Artist -</h4>' + '<p class="song-info">' + data.drawings[i].songArtist + '</p>' + '</div>' + '</div>' + '<h3 class="drawing-header">Lyrics</h3>' + '<p class="drawing-lyrics">' + data.drawings[i].lyrics + '</p>' + '<p class="check-out-song">' + '<a target="about_blank" href="' + data.drawings[i].songLink + '">Check Out the Song</a>' + '</p>' + '<h3 class="drawing-header"> Update Drawing </h3>' + '<div>' + '<form id="update-drawing">' + '<fieldset class="update-fields">' + '<input class="hidden" type="text" name="credentials[_id]" value="' + data.drawings[i]._id + '">' + 'Image Link <br>' + '<input type="text" class="update-form" name="credentials[imageLink]" value="' + data.drawings[i].imageLink + '">' + '<br>' + 'Song Title <br>' + '<input type="text" class="update-form" name="credentials[songTitle]" value="' + data.drawings[i].songTitle + '">' + '<br>' + 'Song Artist <br>' + '<input type="text" class="update-form" name="credentials[songArtist]" value="' + data.drawings[i].songArtist + '">' + '<br>' + 'Lyrics <br>' + '<input type="text" class="update-form" name="credentials[lyrics]" value="' + data.drawings[i].lyrics + '">' + '<br>' + 'Link to Song <br>' + '<input type="text" class="update-form" name="credentials[songLink]" value="' + data.drawings[i].songLink + '">' + '<br>' + '<input id="' + data.drawings[i]._id + '"class="btn btn-success" type="submit" name="submit" value="Update Drawing">' + '</fieldset>' + '</form>' + '<form id="delete-drawing">' + '<fieldset class="update-fields">' + '<input class="hidden" type="text" name="credentials[_id]" value="' + data.drawings[i]._id + '">' + '<input id="' + data.drawings[i]._id + '"class="btn btn-danger delete-button" type="submit" name="submit" value="Delete Drawing">' + '</fieldset>' + '</form>' + '</div>');
  }
};

var onGetDrawingsSuccess = function onGetDrawingsSuccess(data) {
  // console.log('Got Drawings Success')
  // console.log(data)
  loopAllDrawings(data);
};

var onGetDrawingsFailure = function onGetDrawingsFailure() {
  // console.log('Got Drawings Failed')
};

var onGetUserDrawingsSuccess = function onGetUserDrawingsSuccess(data) {
...
var onGetUserDrawingsFailure = function onGetUserDrawingsFailure(data) {
  // console.log('Failed to get User Drawings')
};

var onAddDrawingSuccess = function onAddDrawingSuccess(data) {
...
var onAddDrawingIncomplete = function onAddDrawingIncomplete() {
  $('<p class="error">Please Fill All Fields</p>').insertAfter('#create-drawing').delay(3000).fadeOut();
};

var onAddDrawingBadLink = function onAddDrawingBadLink() {
...
var onAddDrawingBadUrl = function onAddDrawingBadUrl() {
  // console.log('bad url')
  // $('#image-link').append('<p class="error">Please provide proper link</p>')
  $('#image-link').siblings('.error-small').remove();
...
var onAddDrawingFailure = function onAddDrawingFailure(data) {
  // console.log('Add Drawing Failed')
};

var onDeleteDrawingSuccess = function onDeleteDrawingSuccess() {
  // console.log('Delete Successfull')
  $('#delete-drawing').siblings('.error').remove();
  $('<p class="success">Drawing Deleted</p>').insertBefore('#delete-drawing');
};

var onDeleteDrawingFailure = function onDeleteDrawingFailure() {
  // console.log('Delete Failed')
};

var onUpdateDrawingSuccess = function onUpdateDrawingSuccess() {
...
var onUpdateDrawingIncomplete = function onUpdateDrawingIncomplete() {
  // console.log('Incomplete')
  $('#update-drawing').siblings('.error').remove();
  $('<p class="error">Please Fill All Fields</p>').insertAfter('#update-drawing');
};

var onUpdateDrawingBadLink = function onUpdateDrawingBadLink() {
...
var onUpdateDrawingBadUrl = function onUpdateDrawingBadUrl() {
  // console.log('bad url')
  $('#update-drawing').siblings('.error').remove();
  $('<p class="error">Error: Please Provide Valid URL</p>').insertAfter('#update-drawing');
};

var onUpdateDrawingFailure = function onUpdateDrawingFailure() {
  // console.log('Update Failed')
};

module.exports = {
  onGetDrawingsSuccess: onGetDrawingsSuccess,
  onGetDrawingsFailure: onGetDrawingsFailure,
  onGetUserDrawingsSuccess: onGetUserDrawingsSuccess,
  onGetUserDrawingsFailure: onGetUserDrawingsFailure,
  onAddDrawingSuccess: onAddDrawingSuccess,
  onAddDrawingFailure: onAddDrawingFailure,
  onDeleteDrawingSuccess: onDeleteDrawingSuccess,
  onDeleteDrawingFailure: onDeleteDrawingFailure,
  onUpdateDrawingSuccess: onUpdateDrawingSuccess,
  onUpdateDrawingFailure: onUpdateDrawingFailure,
  onAddDrawingIncomplete: onAddDrawingIncomplete,
  onAddDrawingBadLink: onAddDrawingBadLink,
  onAddDrawingBadUrl: onAddDrawingBadUrl,
  onUpdateDrawingIncomplete: onUpdateDrawingIncomplete,
  onUpdateDrawingBadLink: onUpdateDrawingBadLink,
  onUpdateDrawingBadUrl: onUpdateDrawingBadUrl
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
